...
<?php
    $fetch = "select * from register where Role = 'Agent'";
      ...
      <table class="table text-start align-middle table-bordered table-hover mb-0" id="myTable">
           ...
           <tr class="text-white">
             ...
             while($x = mysqli_fetch_array($execute)){
                 ...
                 <td >$x[6]</td>
                 <td >$x[8]</td>
                 <td ><a href='$x[9]' target='_blank' ><img src='$x[9]'   width='50' height='50' /></a></td>
                 <td><a href='deleteagent.php?id=$x[0]'>Delete</a></td>
                 <td><a href='editagent.php?id=$x[0]'>Edit</a></td>
                 </tr>";
             }
